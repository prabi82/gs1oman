...
<?php 
	...
	if(isset($_POST['submit'])){
		...
		//COMPANY DETAILS START
			...
			$discount_amount_input	=	$_POST['discount_amount_input'];
		...
		//CR DETAILS START 
			...
			$vat_registration_number	=	$_POST['vat_number'];
		// CR DETAILS WRAP
		...
		//Promo Code 
			$param1 	= 	$_POST['registration_fee'];
			$param2 	= 	$annual_subscription_fee;
			$vat_amount = 	$_POST['vat_amount'];//vat amount added
			$promo_code = 	$_POST['promo_code'];
	

		if (!empty($promo_code)) {
			// Fetch the promo code details including the expiry date
			$sql 	=	"SELECT promoregistration_fee, promoannual_fee, expiry_date FROM promo_codes WHERE promo_code = '$promo_code'";
			...
			if ($result && mysqli_num_rows($result) > 0) {
				...
				if ($current_date > $row['expiry_date']) {
					...
					$discount1 				= 	$param1 * ($row['promoregistration_fee'] / 100);
					$discount2 				= 	$param2 * ($row['promoannual_fee'] / 100);
					$discount1_percentage 	= 	$row['promoregistration_fee'].'%';
					$discount2_percentage 	= 	$row['promoannual_fee'].'%';
					
					$total_amount_discount 	= 	$discount1 + $discount2;
					$final_amount 			= 	$param1 + $param2 - $total_amount_discount;
					
					//After Discount added vat and value is 
					$grand 				= 	$final_amount + ($final_amount * 0.05);
					//$granddiscount5 	= 	$grand - ($grand * 0.05);
					$granddiscount5 	= 	$grand;
					$vat_amount 		= 	$grand-$final_amount; //vat amount 
					
					json_encode([
						'success' 				=> 	true,
						'message' 				=> 	'Promo code applied! Your total discount amount is: ' . $total_amount_discount . ' and the total amount is ' . $granddiscount5,
						'amount' 				=> 	$granddiscount5,
						'discountamount' 		=> 	$total_amount_discount,
						'additional_message' 	=> 'If you add or remove a new product, please reapply the promo code to get the discount.'
					]);
				}
			} else {
				json_encode(['success' => false, 'message' => 'Invalid or expired promo code.']);
			}
		} 
		else {
			// Run normal code if no promo code is applied
			$final_amount 			= 	$annual_total_price;
			$grand 					= 	$final_amount + ($final_amount * 0.05);
			//$granddiscount5 		= 	$grand - ($grand * 0.05);
			$granddiscount5 		= 	$grand;
			$vat_amount 			= 	$grand-$final_amount; //vat amount 
			...
			json_encode([
				'success' 	=> 	true,
				'message' 	=> 	'No promo code applied. The total amount is ' . $grand,
				'amount' 	=> 	$grand
			]);
		}
		//Add More WRAP
		...
		$email_temp =	'
			<html xmlns="http://www.w3.org/1999/xhtml">
				<head>
					...
					<!-- Responsive Mobile-First Email Template by Konstantin Savchenko, 2015. https://github.com/konsav/email-templates/  -->
					<style>
									...
									<table border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#FFFFFF"width="560" style="border-collapse: collapse; border-spacing: 0; padding: 0; width: inherit; max-width: 560px;" class="container">
										...
										<tr>
											<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%; padding-top: 25px; color: #000000;font-family: sans-serif;" class="paragraph" >
												Once It will be approved by admin then you can log-in successfully.
											</td>
										</tr>
											...
											<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%;" class="list-item">
												...
												<table align="center" border="0" cellspacing="0" cellpadding="0" style="width: inherit; margin: 0; padding: 0; border-collapse: collapse; border-spacing: 0;">
													...
													<!-- LIST ITEM -->
														<tr>
															<td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0;padding-top: 30px; padding-right: 20px;">
																<img border="0" vspace="0" hspace="0" style="padding: 0; margin: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: block; color: #000000;"src="https://raw.githubusercontent.com/konsav/email-templates/master/images/list-item.png" width="50" height="50">
															</td>
													...
													<tr>
														...
														<td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; padding-top: 30px; padding-right: 20px;">
															<img border="0" vspace="0" hspace="0" style="padding: 0; margin: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: block; color: #000000;" src="https://raw.githubusercontent.com/konsav/email-templates/master/images/list-item.png" alt="D" title="Designer friendly" width="50" height="50">
														</td>
														...
														<td align="left" valign="top" style="font-size: 17px; font-weight: 400; line-height: 160%; border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
															...
															font-family: sans-serif;" class="paragraph">
																...
																<li>Annual Subscription Feee: &nbsp; '.$annual_subscription_fee.'</li>
													...
													<table border="0" cellpadding="0" cellspacing="0" align="center" style="max-width: 240px; min-width: 120px; border-collapse: collapse; border-spacing: 0; padding: 0;">
														<tr>
															<td align="center" valign="middle" style="padding: 12px 24px; margin: 0; text-decoration: underline; border-collapse: collapse; border-spacing: 0; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; -khtml-border-radius: 4px;" bgcolor="#E9703E">
																<a target="_blank" style="text-decoration: underline; color: #FFFFFF; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 120%;" href="'.$base_url.'">
																	GS1 Oman
																</a>
															</td>
														</tr>
		...
		// Validation for VAT Registration Number (alphanumeric)

		if (!empty($vat_registration_number) && !ctype_alnum($vat_registration_number)) {
			echo "<script>alert('VAT Registration Number must be alphanumeric.');</script>";
		...
		if(mysqli_num_rows($res) > 0){
			...
			// Upload Document Start 
			    ...
			    if (move_uploaded_file($documents_tmp_name, $documents_path)) {
			        // echo "File Default uploaded successfully!";
			    } else {
			        // echo "File Default upload failed!";
			    }
				...
				//3rd Document
					...
					if (move_uploaded_file($doc_tmp_name3, $doc_path3)) {
				        ...
				        // echo "File 3 upload failed!";
				    }

				// Set record_date to today's date
				$record_date = date('Y-m-d');

				$sql="INSERT INTO `company_tbl`(product_id, product_name, registration_fee, gtins_annual_fee, gln_price, sscc_price,  annual_subscription_fee,annual_total_price,  name, name_ar, pobox, zipcode, address, address_ar, country, city, mobile_number, phone_number, fax_number, website_address, cr_number, cr_legal_type, cr_registration_date, cr_expiry_date, cr_tax_registration_number, user_email, password, cpassword, business_type_product_category, number_of_employee, upload_document1 , upload_document2, upload_document3, healthcare_status,main_contact_status,tnc,captcha_code,record_date,tax_reg_no,riyada_certificate,issue_date,exp_date,documents_req,status,discount_amount,reg_discount,annual_discount,vat_number,vat_amount,promo_code) VALUES ('$product_id','$product_name', '$registration_fee', '$gtins_annual_fee', '$gln_price', '$sscc_price', '$annual_subscription_fee', '$granddiscount5',  '$name', '$name_ar', '$pobox', '$zipcode','$address', '$address_ar', '$country', '$city','$mobile_number', '$phone_number', '$fax_number', '$website_address','$cr_number','$cr_legal_type', '$cr_registration_date','$cr_expiry_date','$cr_tax_registration_number', '$user_email', '$password','$cpassword','$business_type_product_category','$number_of_employee', '$doc_path1','$doc_path2','$doc_path3','$healthcare_status','$main_contact_status','$tnc', '$captcha_code','$record_date','$tax_reg_no','$riyada_certificate','$issue_date','$exp_date','$documents_req','0','$total_amount_discount','$discount1_percentage','$discount2_percentage','$vat_registration_number','$vat_amount','$promo_code')";
			
			$query=mysqli_query($conn,$sql)or die(mysqli_error($conn));
			
	
			if($query) {
				echo "<script>alert('I/We agree to abide by the GS1 Company Prefix License and accept the GS1 Oman Terms and conditions and the privacy policy.')</script>";  
			}
			if($query){
		...
		<div class="container">
			<form id="registrationForm" method="post" action="process-registration.php" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<label>PO Box	*</label>
						<input type="text" class="form-control number" maxlength="6" name="pobox" placeholder="" pattern="[0-9]+" title="Please enter numbers only" required>
						<span id="pobox_error"></span>
					</div>

					<div class="col-md-6">
						<label>Zip/Postal Code	*</label>
						<input type="text" class="form-control number" maxlength="3" name="zipcode" placeholder="123" pattern="[0-9]+" title="Please enter numbers only" required>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<input type="text" class="form-control number" maxlength="12" name="cr_number" placeholder="CR Number" pattern="[0-9]+" required>
					...
					<div class="col-md-3">
						...
						<input type="text" placeholder="dd-mm-yyyy" class="form-control" name="cr_registration_date" max="<?php echo date('Y-m-d'); ?>" onfocus="(this.type='date')" onchange="validateRegistrationDate()">
					</div>
					<div class="col-md-3">
						<label>CR Expiry Date</label>
						<input type="text" placeholder="dd-mm-yyyy" class="form-control" name="cr_expiry_date" min="<?php echo date('Y-m-d'); ?>" onfocus="(this.type='date')" onchange="validateExpiryDate()">
					</div>
					<div class="col-md-3">
						<label>Tax Registration Number</label>
						<input type="text" class="form-control number" maxlength="12" name="cr_tax_registration_number" placeholder="Tax Registration Number" pattern="[0-9]+">
					</div>
					<div class="col-md-3">
						<label>VAT</label>
						<input type="text" class="form-control alpha_num" maxlength="15" id="vat_registration_number" name="vat_number" placeholder="VAT Registration Number">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<input type="text" class="form-control number" maxlength="7" name="number_of_employee">
					</div>
				</div>
		  ...
		  <!--<div class="row">
			...
			<div id="offline_payment_instructions" style="display: none;">
				...
				<div class="col-md-12 text-center">
					<button  type="button" name="submit_draft" id="reg_form_button" class="btn btn-success"style="color: #ffffff;background-color: #f34006;border-color: #f34006;">
						Sign Up
					</button>
					<button  type="submit" name="submit" id="reg_form_button_sub" class="btn btn-success"style="color: #ffffff;background-color: #f34006;border-color: #f34006;" hidden>
						Sign Up
					</button>
				</div>
				<div id="response"></div>
