...
<input type="radio" name="healthcare_status" value="Yes" <?php echo ($company_row['healthcare_status'] == 'Yes') ? 'checked' : ''; ?> class="tick" required disabled> &nbsp; Yes
<input type="radio" name="healthcare_status" value="No" <?php echo (strcasecmp($company_row['healthcare_status'], 'No') == 0) ? 'checked' : ''; ?> class="tick" required disabled>&nbsp; No
...
<a href="<?='https://gs1oman.com/'.$upload_document1?>" download><span class='badge badge-success'>Download</span></a>

</div>
<div class="col-lg-4 col-md-4 text-center">
<label>Chamber of Commercial Certificate </label><br>

<a href="<?='https://gs1oman.com/'.$upload_document2?>" download><span class='badge badge-success'>Download</span></a>

</div>
<div class="col-lg-4 col-md-4 text-center">
<label>Other Documnets</label><br>

<a href="<?='https://gs1oman.com/'.$upload_document3?>" download><span class='badge badge-success'>Download</span></a>
                              ...
                              <div class="row gutters">
                                 <div class="col-xl-12">
                                   <input type="submit" id="submit" name="submit" class="btn btn-primary" value="Update">
                                    <a href="show.php?page=REV"><input type="button" name="cancel" class="btn btn-warning" value="Back"></a>
                                 </div>
                              </div>
                           </div>
                        </div>
