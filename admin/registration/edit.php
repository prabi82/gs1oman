...
if(isset($_POST['submit'])) {
    try {
        ...
        // After successful database updates, send email
        ...
        $emailHandler->sendRegistrationEmail($userData);
        ...
        try {
            $emailHandler = new EmailHandler();
            $emailHandler->sendErrorNotification($e->getMessage());
...
`riyada_certificate`= '$riyada_certificate',
...
// Initialize all variables from database result
$name = isset($company_row['name']) ? $company_row['name'] : '';
$name_ar = isset($company_row['name_ar']) ? $company_row['name_ar'] : '';
$pobox = isset($company_row['pobox']) ? $company_row['pobox'] : '';
$zipcode = isset($company_row['zipcode']) ? $company_row['zipcode'] : '';
$address = isset($company_row['address']) ? $company_row['address'] : '';
$address_ar = isset($company_row['address_ar']) ? $company_row['address_ar'] : '';
$city = isset($company_row['city']) ? $company_row['city'] : '';
$country = isset($company_row['country']) ? $company_row['country'] : '';
$mobile_number = isset($company_row['mobile_number']) ? $company_row['mobile_number'] : '';
$phone_number = isset($company_row['phone_number']) ? $company_row['phone_number'] : '';
$fax_number = isset($company_row['fax_number']) ? $company_row['fax_number'] : '';
$website_address = isset($company_row['website_address']) ? $company_row['website_address'] : '';
$cr_number = isset($company_row['cr_number']) ? $company_row['cr_number'] : '';
$cr_legal_type = isset($company_row['cr_legal_type']) ? $company_row['cr_legal_type'] : '';
$cr_registration_date = isset($company_row['cr_registration_date']) ? $company_row['cr_registration_date'] : '';
$cr_expiry_date = isset($company_row['cr_expiry_date']) ? $company_row['cr_expiry_date'] : '';
$cr_tax_registration_number = isset($company_row['cr_tax_registration_number']) ? $company_row['cr_tax_registration_number'] : '';
$user_email = isset($company_row['user_email']) ? $company_row['user_email'] : '';
$business_type_product_category = isset($company_row['business_type_product_category']) ? $company_row['business_type_product_category'] : '';
$number_of_employee = isset($company_row['number_of_employee']) ? $company_row['number_of_employee'] : '';
$riyada_certificate = isset($company_row['riyada_certificate']) ? $company_row['riyada_certificate'] : '';
$exp_date = isset($company_row['exp_date']) ? $company_row['exp_date'] : '';
$status = isset($company_row['status']) ? $company_row['status'] : '0';
$healthcare_status = isset($company_row['healthcare_status']) ? $company_row['healthcare_status'] : '';
$main_contact_status = isset($company_row['main_contact_status']) ? $company_row['main_contact_status'] : '';
$documents_req = isset($company_row['documents_req']) ? $company_row['documents_req'] : '';
$upload_document1 = isset($company_row['upload_document1']) ? $company_row['upload_document1'] : '';
$upload_document2 = isset($company_row['upload_document2']) ? $company_row['upload_document2'] : '';
$upload_document3 = isset($company_row['upload_document3']) ? $company_row['upload_document3'] : '';
$cpassword = isset($company_row['cpassword']) ? $company_row['cpassword'] : '';
$tax_reg_no = isset($company_row['tax_reg_no']) ? $company_row['tax_reg_no'] : '';
$issue_date = isset($company_row['issue_date']) ? $company_row['issue_date'] : '';
$vat_number = isset($company_row['vat_number']) ? $company_row['vat_number'] : '';

// Initialize contact-related variables
$title = isset($_POST['title']) ? $_POST['title'] : array();
$first_name = isset($_POST['first_name']) ? $_POST['first_name'] : array();
$last_name = isset($_POST['last_name']) ? $_POST['last_name'] : array();
$job_title = isset($_POST['job_title']) ? $_POST['job_title'] : array();
$email_id = isset($_POST['email_id']) ? $_POST['email_id'] : array();
$phone_number1 = isset($_POST['phone_number1']) ? $_POST['phone_number1'] : array();
...
<div class="form-group">
  ...
  <?php 
    $mobile = isset($company_row['mobile_number']) ? $company_row['mobile_number'] : '';
    echo "<!-- Mobile number from DB: " . htmlspecialchars($mobile) . " -->";
  ?>
  <input type="tel" class="form-control" name="mobile_number" id="mobile_number"
         value="<?php echo htmlspecialchars($mobile); ?>"
         placeholder="Enter mobile number (e.g. 968 XXXX XXXX)"
...
<div class="form-group">
  ...
  <?php 
    $phone = isset($company_row['phone_number']) ? $company_row['phone_number'] : '';
    echo "<!-- Phone number from DB: " . htmlspecialchars($phone) . " -->";
  ?>
  <input type="tel" class="form-control" name="phone_number" id="phone_number"
         value="<?php echo htmlspecialchars($phone); ?>"
         placeholder="Enter phone number (e.g. 968 XXXX XXXX)"
...
<div class="form-group">
  ...
  <?php 
    $fax = isset($company_row['fax_number']) ? $company_row['fax_number'] : '';
    echo "<!-- Fax number from DB: " . htmlspecialchars($fax) . " -->";
  ?>
  <input type="tel" class="form-control" name="fax_number" id="fax_number"
         value="<?php echo htmlspecialchars($fax); ?>"
         placeholder="Enter fax number (e.g. 968 XXXX XXXX)"
         maxlength="15">
</div>
...
<input type="text" class="form-control" placeholder="" name="cr_tax_registration_number" value="<?php echo $cr_tax_registration_number; ?>" required>
</div>

<div class="form-group">
<label>VAT Registration Number</label>
<input type="text" class="form-control alpha_num" maxlength="15" name="vat_number" placeholder="VAT Registration Number" pattern="[A-Za-z0-9]{15}" value="<?php echo isset($company_row['vat_number']) ? $company_row['vat_number'] : ''; ?>">
</div>
...
<input type="file" class="form-control" id="payment_receipt" value="<?php echo $documents_req; ?>" name="documents_req">
...
<input type="radio" name="healthcare_status" value="Yes" <?php echo ($company_row['healthcare_status'] == 'Yes') ? 'checked' : ''; ?> class="tick" required> &nbsp; Yes
<input type="radio" name="healthcare_status" value="No" <?php echo (strcasecmp($company_row['healthcare_status'], 'No') == 0) ? 'checked' : ''; ?> class="tick" required>&nbsp; No
...
<div class="form-group">
    ...
    <select class="form-control" name="riyada_certificate" id ="riyada_certificate" required>
        ...
        <option value="Yes"<?php if ($company_row['riyada_certificate'] == "Yes") echo " selected"; ?>>Yes</option>
        <option value="No"<?php if ($company_row['riyada_certificate'] == "No") echo " selected"; ?>>No</option>
    </select>
</div>
<?php
// Assuming $company_row['exp_date'] is in a different format, you can convert it
$exp_date_formatted = date("Y-m-d", strtotime($company_row['exp_date']));
?>
<div class="form-group expiry_date">
<label>Expiry Date*</label>
<input type="date" class="form-control expiry_date" placeholder="" name="exp_date" value="<?php  echo $exp_date_formatted; ?>" required>
</div>
<div class="form-group">
...
<script>
    ...
    function toggleExpiryDateField() {
        if ($('#riyada_certificate').val() === 'Yes') {
            $('.expiry_date').show().attr('required', true);
           // $('.issue_date').show().attr('required', true);
        } else {
            $('.expiry_date').hide().removeAttr('required');
          //  $('.issue_date').hide().removeAttr('required');
        }
    }
    ...
    // Set up the change event listener to call the function when the value of #test changes
