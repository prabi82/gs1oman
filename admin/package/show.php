...
<thead>
	<tr> 
		<th>Sno</th>
		<!--<th>Gtins Product Name</th>-->		<th>Prefix Type</th>
		<!--<th>Gtins Name</th>-->		<th>Package</th>
		<!--<th>Gtins Registration Fee</th>-->		<th>Registration</th>
...
?>
 ...
 <td><a href="edit.php?id=<?php echo $bid;?>&&page=PD"><i class='fa fa-edit' style='font-size:13px; color:#ea490b; ' ></i></a> 
 	<a href="show.php?image_id=<?php echo $bid; ?>&&page=PD"><i class='fa fa-trash' style='font-size:13px; color:#ff0000;'></i></a></td>		
