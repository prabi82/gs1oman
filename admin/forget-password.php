...
$sql="SELECT * FROM `admin_tbl` WHERE  email_id='".$user_email."'";
...
$update = mysqli_query($conn,"UPDATE admin_tbl set reset_link_token='" . $token . "'  WHERE email_id='" . $user_email . "'");
$link = "<a href='".$admin_url."reset-password.php?key=".$user_email."&&token=".$token."' class=''  target='_blank' style='text-decoration:none;'' >Set New Password</a>";
