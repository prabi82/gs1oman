...
if(isset($_GET['view_id']))
{
 ...
 $sql4="UPDATE `order_tbl` SET `prefix_num`='$prefix_num', `gln_number`='$gln_number',`longitude`='$longitude',`latitude`='$latitude', `certificate_img`='$c_img_path', `certificate_pdf`='$c_pdf_path', `status`='$status' WHERE company_id='".$view_id."' && id='".$id."' ";
...
$font1="Lato-Regular.ttf";
 ...
 imagettftext($image,14,0, 530, 319,$color,$font,$prefix_num);

   imagettftext($image,12,0,376, 369,$color,$font,$order_date);

   imagettftext($image,12,0,687, 369,$color,$font,$expired_date);

   imagettftext($image,12,0,305, 240,$color,$font1,$company_name); 
...
$sql4="UPDATE `order_tbl` SET `prefix_num`='$prefix_num', `gln_number`='$gln_number', `longitude`='$longitude',`latitude`='$latitude',`certificate_img`='$c_img_path', `certificate_pdf`='$c_pdf_path',`certificate_glnimg`='$c_img_path_gln', `certificate_glnpdf`='$c_pdf_path_gln',`status`='$status' WHERE company_id='".$view_id."' && id='".$id."' ";
