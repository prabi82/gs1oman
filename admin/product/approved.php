...
<li class="breadcrumb-item"><a href="#">Approved Product</a></li>
...
<a href="show.php?page=PROT">
<input type="submit"  class="btn btn-info" value="All Product">
</a>
<a href="approved.php?page=PROT">
<input type="submit"  class="btn btn-success" value="Approved Product">
</a>
<a href="pending.php?page=PROT"><input type="submit" name="Rejected Product" class="btn btn-warning" value="Rejected Product"></a>
</div>
<!-- Form Group Start -->     
...
<div class="col-md-2">
<div class="t-header">Manage Approved Product</div>
</div>
...
$query=mysqli_query($conn, "SELECT  * FROM `order_tbl` WHERE `status`='1'") or die(mysqli_error());
}
