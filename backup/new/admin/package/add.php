...
$sql="INSERT INTO `product_tbl`(product_name,gtins_name,registration_fee,gtins_annual_fee,gln_annual_fee,  
	sscc_annual_fee,status) VALUES ('$product_name','$gtins_name', '$registration_fee','$gtins_annual_fee',
	'$gln_annual_fee','$sscc_annual_fee','$status' )";
...
<input type="text" class="form-control" id="inputName" value="GTIN: Global Trade Item Numbers" name="product_name" >
</div>


<div class="form-group">
<label for="inputName" class="col-form-label">Gtin Name</label>
<input type="text" class="form-control" id="gtin"  name="gtins_name" >
</div>
...
<input type="number" class="form-control"   name="gtins_annual_fee" >
</div>

<div class="form-group">
<label for="inputName" class="col-form-label">Gln Annual Fee</label>
<input type="number" class="form-control"   name="gln_annual_fee" >
</div>
...
<script>
    ...
    $("#gtin").on('keyup', function() {
        var gtin = $("#gtin").val();
        if (gtin>1000)
         $("#sscc").html("<label for='inputName' class='col-form-label'>Sscc Annual Fee</label><input type='number' class='form-control' name='sscc_annual_fee'>");
        else if (gtin<=1000)
          $("#sscc").html("<input type='number' class='form-control d-none' name='sscc_annual_fee'>");
        else
          $("#sscc").html("");
