...
<!-- Mirrored from bootstrap.gallery/wafi-admin/dashboard-v2/topbar/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Jan 2021 09:31:57 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
					...
					<div class="col-xl-5 col-lg-6 col-md-6 col-sm-12">
						<div class="login-screen">
							<div class="login-box">
								...
								<hr>
								<div class="m-0">
									<span class="additional-link">Have an account? <a href="login.html" class="btn btn-dark">Login</a></span>
								</div>
							</div>
						</div>
					</div>
