...
<div class="form-group">
<label for="inputName" class="col-form-label">2nd Document</label>
...
<div class="form-group">
<label for="inputName" class="col-form-label">1st Document</label>
<input type="file" class="form-control" name="upload_document1" value="<?=$upload_document1?>">
</div>


<div class="form-group">
<label for="inputName" class="col-form-label">3rd Document</label>
