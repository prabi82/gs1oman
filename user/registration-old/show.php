...
if($stype!=''){
$query=mysqli_query($conn, "SELECT  * FROM `company_tbl` WHERE `status`='$stype' AND user_email='".$_SESSION['user_email']."'") or die(mysqli_error());
}
else{
...
?>	
		...
		<td><a href="edit.php?view_id=<?=$fetch['id']?>">
			<span class='badge badge-warning'>Edit</span>
		</a>|<a href="view.php?view_id=<?=$fetch['id']?>"><span class='badge badge-info'>View</span></a></td>
