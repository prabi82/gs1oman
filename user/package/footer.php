...
<script>
    ...
    gln_price = $("#gln_price").val();	sscc_price = $("#sscc_price").val();
    ...
    }	if($('#gtins_annual_fee').is(':checked')) { 	total_price = parseInt(total_price) + parseInt(gtins_annual_fee);    annual_total_price = parseInt(annual_total_price) + parseInt(gtins_annual_fee);    }	
