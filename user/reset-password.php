...
$get_email=$_GET['key'];
$token=$_GET['token'];
$sql="SELECT * FROM `company_tbl` WHERE  user_email='".$get_email."'";
...
<body bgcolor="#E8ECF1">
            ...
            <td bgcolor="#ffffff">
              <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="100%">
                <tr>
                  ...
                  <a href="'.$user_url.'" target="_blank" style="text-decoration:none;">Login Here</a>
 ...
 if($password!=$cpassword){
	...
	$pass=sha1($password);
$sql="UPDATE `company_tbl` SET  `password`='$pass' , `cpassword`='$cpassword' WHERE reset_link_token='$token' AND user_email='".$get_email."'";
...
//echo "<script>alert('Something Wrong.')</script>";
  ...
  $sql1="UPDATE `company_tbl` SET  `reset_link_token`='' WHERE  user_email='".$get_email."'";
...
{
echo "
<div id='alert' class='alert alert-danger text-center' role='alert'>".$_SESSION['forget1']."</div>
";
}
...
{
echo "
<div id='alert1' class='alert alert-success text-center' role='alert'>".$_SESSION['forget']."</div>
";
}
...
{
echo "
<div id='alert2' class='col-md-12 alert alert-danger alert-dismissible fade show' role='alert' style='
    background: #cd3118; padding: 17px 0 0;
;'>
<p style='color:#e9f1eb; text-align:center; !important;'>".$_SESSION['message11']."</p>
...
<?php 
if(isset($_SESSION['message12']))
{
echo "
<div id='alert2' class='col-md-12 alert alert-danger alert-dismissible fade show' role='alert' style='
    background: #cd3118; padding: 17px 0 0;
;'>
<p style='color:#e9f1eb; text-align:center; !important;'>".$_SESSION['message12']."</p>
